export const ROOM_NAMES = {
  ...
  'mimica-relampago': ['Palco Neon', 'Cena Aberta', 'Turno de Ouro', 'Riso em Cena'],
  ...
  'se-fosse-voce': ['Modo Hipotese', 'Sala E Se', 'Resposta Instantanea', 'Plano Imaginario'],
  ...
  'quem-mais-provavel': ['Radar da Mesa', 'Voto Raro', 'Quem Tem Cara', 'Probabilidade Maxima'],
};
